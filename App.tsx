...
const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center bg-slate-950 overflow-x-hidden text-rose-100 selection:bg-rose-500/30 pt-12 pb-24 sm:pt-20">
      ...
      {/* Landing State - Centered vertically in the viewport initially */}
      {!isStarted && (
        <div className="flex-1 flex flex-col items-center justify-center z-20 animate-in fade-in zoom-in duration-1000 gap-6 sm:gap-10 px-4 text-center">
          <div className="relative group w-full max-w-xs sm:max-w-none">
          ...
          <p className="text-rose-300/60 font-dancing text-xl sm:text-2xl animate-pulse tracking-widest italic">A melody of my love for Marfie</p>
        </div>
      )}
      ...
      {/* Message Layer - Adjusted mt to move it higher up at the top */}
      {isBloomComplete && (
        <div className="z-30 w-full max-w-3xl px-6 sm:px-8 text-center animate-in fade-in slide-in-from-bottom-16 duration-[2000ms] delay-700 flex flex-col gap-6 sm:gap-8 mt-4 sm:mt-10 mb-20">
          ...
          <div className="mt-4">
            <p className="font-calligraphy text-3xl sm:text-5xl text-rose-500 animate-pulse drop-shadow-sm">Love Always! Ash</p>
          </div>
        </div>
      )}
